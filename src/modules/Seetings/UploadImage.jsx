  ...
  return (
    <div>
      <div className="row input-title" style={{ marginTop: "35px" }}>
        <div className="col-11 col-md-6 input-head row">
          ...
          <div className="col-12 col-md-6">
            <div className="d-flex align-items-center">
              ...
              {
                selectedImages.length > 0 ? <span className="ms-3" style={{color:'#ef5b0c'}}>File Selected</span> : <span className="ms-3">No file chosen</span>
              }
