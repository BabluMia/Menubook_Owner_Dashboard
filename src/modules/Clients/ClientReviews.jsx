    ...
    <div className="parent text-capitalize">
      <div className="main-div">
        ...
        <div className="filter_search  mt-4 row">
          ...
          <div className=" mb-3 d-flex align-items-center col-12 col-md-8 col-lg-3 my-1 my-md-0">
            <span className="me-2" style={{ fontSize: "14px" ,minWidth:'60px'}}>
              Filter by :{" "}
            </span>
            <select name="" id="" className="me-2">
              <option value="All">New</option>
          ...
          <div className=" mb-3 col-12 col-md-8 col-lg-3 my-1 my-md-0">
