          ...
          <Table sx={{ minWidth: 650 }} aria-label="caption table">
            ...
            <TableHead>
              <TableRow>
                ...
                <TableCell align="left" style={{minWidth:'130px'}}>User</TableCell>
                <TableCell align="left">Comments</TableCell>
                
                <TableCell style={{minWidth:'130px'}} align="left">MBBD Rating</TableCell>
              ...
              {userlist.map((row) => {
                ...
                return (
                  <TableRow key={row.id}>
                    ...
                    <TableCell align="left" >
                      <div className="d-flex align-items-center justify-content-between gap-2 td-name">
