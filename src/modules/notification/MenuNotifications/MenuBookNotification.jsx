...
import MenuBookNotificationList from "./MenuBookNotificationList";

const MenuBookNotification = () => {
      ...
      <div className="main-div">
        <div className="new-user mt-4">
          <div className="d-flex gap-3 align-items-center">
            <p>Notification</p>
            <button className="orange-btn" onClick={()=>history.push('/add-notification')}>Add New</button>
          </div>
        </div>
        <div className="filter_search  mt-4 row">
          ...
          <div className="mb-3 d-flex c col-12 col-md-8 col-lg-3 my-1 my-md-0">
            <span className="me-2 my-auto" style={{ fontSize: "14px",minWidth:'60px' }}>
              Sort by :{" "}
            </span>
            <select name="" id="" className="me-2">
...
export default MenuBookNotification;
